...
export class DishListService {
  ...
  myDishes: Dish[] = [
    ...
    , new Dish(0,8,12, "Lody włoskie", "Włoska", "Lody", ["śmietana", "rożek", "polewa"], 12, 1, "Smak wakacji", "https://drive.google.com/uc?export=view&id=1IQSfwVF08FEIpxoUDLUSwUT4hL-XcuT7")
    , new Dish(0,9,7, "Świderek", "Polska", "Lody", ["śmietana", "wafel", "chefs-kiss"], 7, 3, "Najlepsze lody <3", "https://drive.google.com/uc?export=view&id=1ehmHPZUmame5KcXEHOJgFEcDFxakz6yp")
    , new Dish(0,10,10000, "Jakiś ślimak", "Francuska", "Inne", ["ślimak", "woda do wypłukania ust"], 10000, 100, "Fuj", "https://drive.google.com/uc?export=view&id=1gXK1LdlI3S3NCq7G4ThZUHUZqVAzDiDG")
